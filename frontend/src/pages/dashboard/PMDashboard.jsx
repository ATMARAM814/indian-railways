...
import { getPmDashboardData } from '../../api/dashboardApi';
import { 
...
const PMDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    setError(null);
    try {
      const res = await getPmDashboardData();
      if (res.success) {
        setData(res.data);
      } else {
      ...
      <div className="dashboard-content">
        <div className="page-header-container">
          ...
          <p className="page-subtitle">
            Welcome back, <strong>{user?.fullName || user?.full_name || 'Railway Pointsman'}</strong>. Here is your evaluation progress summary.
          </p>
        </div>
