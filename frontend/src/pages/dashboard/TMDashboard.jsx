...
import { getTmDashboardData } from '../../api/dashboardApi';
import { 
...
const TMDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    setError(null);
    try {
      const res = await getTmDashboardData();
      if (res.success) {
        setData(res.data);
      } else {
      ...
      <div className="dashboard-content">
        <div className="page-header-container">
          ...
          <p className="page-subtitle">
            Welcome back, <strong>{user?.fullName || user?.full_name || 'Railway Train Manager'}</strong>. Here is your evaluation progress summary.
          </p>
        </div>
